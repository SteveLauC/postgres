...
def show_help():
    ...
    print("  install       - Install the compiled project.")
    ...
    print("  psql          - Start master, connect with psql, then stop master.")
